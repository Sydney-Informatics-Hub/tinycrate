...
def test_resolve_term_with_local_context(contexts):
    ...
    assert resolver.resolve_term("local") == "arcp://name,corpus-of-oz-early-english/terms#"
    assert resolver.resolve_term("local:whatever") == "arcp://name,corpus-of-oz-early-english/terms#whatever"
